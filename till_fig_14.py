...
Original file is located at
    https://colab.research.google.com/drive/147mHL2-rc0MrwvcNxAYVed_Fi99vz4LE
"""
...
def calculate_h_prime(h, M, N):
    Fhead = (M * h**2) / (M - h) * np.log(M / h)
    Ftail = (N * h**2) / (N - h) * (np.log(N / h)) - h**2
    h_prime = np.sqrt((Fhead - h**2) / Ftail) * h
    return h_prime
...
def process_excel_files(uploaded_files):
    ...
    for file_name in uploaded_files.keys():
        ...
        for sheet_name in xls.sheet_names:
            ...
            h_prime = calculate_h_prime(h_index, M, N)
...
plot_scatter_with_regression(results_df['r-index'], results_df['r-index'], 'r-index', 'new-r-index')
plot_scatter_with_regression(results_df['a-index'], results_df['new-a-index'], 'a-index', 'new-a-index')
plot_scatter_with_regression(results_df['hg-index'], results_df['hg-index'], 'hg-index', 'new-hg-index')
